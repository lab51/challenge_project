...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'kernel.bundles' => array(
                ...
                'Lab51ChallengeBundle' => 'Lab51\\ChallengeBundle\\Lab51ChallengeBundle',
                'Lab51UserBundle' => 'Lab51\\UserBundle\\Lab51UserBundle',
                'Lab51InboxBundle' => 'Lab51\\InboxBundle\\Lab51InboxBundle',
                'DebugBundle' => 'Symfony\\Bundle\\DebugBundle\\DebugBundle',
                'AcmeDemoBundle' => 'Acme\\DemoBundle\\AcmeDemoBundle',
                'AcmeTestBundle' => 'Acme\\TestBundle\\AcmeTestBundle',
                'SSZubrBundle' => 'SS\\ZubrBundle\\SSZubrBundle',
            ...
            'locale' => 'en',
            'secret' => '03c1e6892390912f5263309f0ad7fe3668478ad0',
            ...
            'kernel.secret' => '03c1e6892390912f5263309f0ad7fe3668478ad0',
            ...
            'assetic.ruby.bin' => '/Users/simon/.rbenv/shims/ruby',
            'assetic.sass.bin' => '/Users/simon/.rbenv/shims/sass',
        ...
        $this->methodMap = array(
            ...
            'status.controller' => 'getStatus_ControllerService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'workout', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'unix_socket' => '/tmp/mysql.sock', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => (dirname(dirname(dirname(__DIR__))).'/src/Lab51/ChallengeBundle/Entity'), 1 => (dirname(dirname(dirname(__DIR__))).'/src/Lab51/UserBundle/Entity'), 2 => (dirname(dirname(dirname(__DIR__))).'/src/Lab51/InboxBundle/Entity'), 3 => (dirname(dirname(dirname(__DIR__))).'/src/SS/ZubrBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Lab51\\ChallengeBundle\\Entity');
        $c->addDriver($b, 'Lab51\\UserBundle\\Entity');
        $c->addDriver($b, 'Lab51\\InboxBundle\\Entity');
        $c->addDriver($b, 'SS\\ZubrBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('Lab51ChallengeBundle' => 'Lab51\\ChallengeBundle\\Entity', 'Lab51UserBundle' => 'Lab51\\UserBundle\\Entity', 'Lab51InboxBundle' => 'Lab51\\InboxBundle\\Entity', 'SSZubrBundle' => 'SS\\ZubrBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_5dfdbf7805f12d5fafe38386fb40c934d5b2d502a26bfdd10860de109a5c46d5');
    ...
    /**
     * Gets the 'status.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Controller\StatusController A AppBundle\Controller\StatusController instance.
     */
    protected function getStatus_ControllerService()
    {
        return $this->services['status.controller'] = new \AppBundle\Controller\StatusController($this);
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('current_session', $this->get('status.controller'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Lab51/ChallengeBundle/Resources/views'), 'Lab51Challenge');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Lab51/UserBundle/Resources/views'), 'Lab51User');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Lab51/InboxBundle/Resources/views'), 'Lab51Inbox');
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Acme/TestBundle/Resources/views'), 'AcmeTest');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/SS/ZubrBundle/Resources/views'), 'SSZubr');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('03c1e6892390912f5263309f0ad7fe3668478ad0');
    }
